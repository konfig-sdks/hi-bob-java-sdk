...
public class ListItem {
  ...
  **/
  ...
  @ApiModelProperty(value = "Internal ID of the item.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether the item is archived (not available for selection).")
  ...
  public ListItem children(List<ListItem> children) {
  ...
  public ListItem addChildrenItem(ListItem childrenItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Nested items - if the list is nested.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, listItem.id) &&
        ...
        Objects.equals(this.children, listItem.children)&&
        Objects.equals(this.additionalProperties, listItem.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, archived, children, additionalProperties);
  }
      ...
      if (jsonObj.get("children") != null && !jsonObj.get("children").isJsonNull()) {
        ...
        if (jsonArraychildren != null) {
          ...
          for (int i = 0; i < jsonArraychildren.size(); i++) {
            ListItem.validateJsonObject(jsonArraychildren.get(i).getAsJsonObject());
          };
        }
      }
  }
