...
public class Field {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Category of the field.")
  ...
  **/
  ...
  public Field jsonPath(String jsonPath) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A dot-separated path of this field value in the employee JSON returned by the /v1/profiles endpoint.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of the field. Supported field types: text, text-area, number, date, list, multi-list, hierarchy-list, currency, employee-reference, document.")
  ...
  public Field typeData(FieldTypeData typeData) {
  ...
  **/
  ...
  public Field historical(Boolean historical) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, field.description) &&
        ...
        Objects.equals(this.jsonPath, field.jsonPath) &&
        Objects.equals(this.type, field.type) &&
        Objects.equals(this.typeData, field.typeData) &&
        Objects.equals(this.historical, field.historical)&&
        Objects.equals(this.additionalProperties, field.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, id, category, name, jsonPath, type, typeData, historical, additionalProperties);
  }
