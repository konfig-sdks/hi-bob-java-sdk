...
public class EquityEntry {
  ...
  public EquityEntry id(Integer id) {
  ...
  **/
  ...
  public EquityEntry reason(String reason) {
  ...
  **/
  ...
  public EquityEntry effectiveDate(LocalDate effectiveDate) {
  ...
  **/
  ...
  public EquityEntry quantity(Double quantity) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The number of equities granted.")
  ...
  public EquityEntry equityType(String equityType) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The type of the grant.")
  ...
  public EquityEntry vestingCommencementDate(LocalDate vestingCommencementDate) {
  ...
  **/
  ...
  public EquityEntry consentNumber(String consentNumber) {
  ...
  **/
  ...
  public EquityEntry grantDate(LocalDate grantDate) {
  ...
  **/
  ...
  public EquityEntry optionExpiration(LocalDate optionExpiration) {
  ...
  **/
  ...
  public EquityEntry exercisePrice(CurrencyValue exercisePrice) {
  ...
  **/
  ...
  public EquityEntry vestingTerm(String vestingTerm) {
  ...
  **/
  ...
  public EquityEntry grantType(String grantType) {
  ...
  **/
  ...
  public EquityEntry vestingSchedule(Double vestingSchedule) {
  ...
  public EquityEntry vestingSchedule(Integer vestingSchedule) {
  ...
  **/
  ...
  public EquityEntry grantNumber(Double grantNumber) {
  ...
  **/
  ...
  public EquityEntry grantStatus(String grantStatus) {
  ...
  **/
   ...
   * @return the EquityEntry instance itself
   */
  public EquityEntry putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EquityEntry equityEntry = (EquityEntry) o;
    return Objects.equals(this.id, equityEntry.id) &&
        Objects.equals(this.reason, equityEntry.reason) &&
        Objects.equals(this.effectiveDate, equityEntry.effectiveDate) &&
        Objects.equals(this.quantity, equityEntry.quantity) &&
        Objects.equals(this.equityType, equityEntry.equityType) &&
        Objects.equals(this.vestingCommencementDate, equityEntry.vestingCommencementDate) &&
        Objects.equals(this.consentNumber, equityEntry.consentNumber) &&
        Objects.equals(this.grantDate, equityEntry.grantDate) &&
        Objects.equals(this.optionExpiration, equityEntry.optionExpiration) &&
        Objects.equals(this.exercisePrice, equityEntry.exercisePrice) &&
        Objects.equals(this.vestingTerm, equityEntry.vestingTerm) &&
        Objects.equals(this.grantType, equityEntry.grantType) &&
        Objects.equals(this.vestingSchedule, equityEntry.vestingSchedule) &&
        Objects.equals(this.grantNumber, equityEntry.grantNumber) &&
        Objects.equals(this.grantStatus, equityEntry.grantStatus)&&
        Objects.equals(this.additionalProperties, equityEntry.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, reason, effectiveDate, quantity, equityType, vestingCommencementDate, consentNumber, grantDate, optionExpiration, exercisePrice, vestingTerm, grantType, vestingSchedule, grantNumber, grantStatus, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EquityEntry {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("equityType");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EquityEntry
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EquityEntry.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EquityEntry is not found in the empty JSON string", EquityEntry.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EquityEntry.openapiRequiredFields) {
      ...
      if (!jsonObj.get("equityType").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EquityEntry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EquityEntry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EquityEntry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EquityEntry.class));

       return (TypeAdapter<T>) new TypeAdapter<EquityEntry>() {
           @Override
           public void write(JsonWriter out, EquityEntry value) throws IOException {
           ...
           @Override
           public EquityEntry read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EquityEntry instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EquityEntry given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EquityEntry
  * @throws IOException if the JSON string is invalid with respect to EquityEntry
  */
  public static EquityEntry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EquityEntry.class);
  }

 /**
  * Convert an instance of EquityEntry to an JSON string
  *
  * @return JSON string
  */
