...
import com.konfigthis.client.model.ListItem;
...
public class List {
  ...
  **/
  ...
  public List items(List<ListItem> items) {
  ...
  public List addItemsItem(ListItem itemsItem) {
    if (this.items == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The elements in the list.")
  ...
  public boolean equals(Object o) {
    ...
    List list = (List) o;
    return Objects.equals(this.name, list.name) &&
        Objects.equals(this.items, list.items)&&
        Objects.equals(this.additionalProperties, list.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, items, additionalProperties);
  }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            ListItem.validateJsonObject(jsonArrayitems.get(i).getAsJsonObject());
          };
        }
      }
  }
